...
pub(crate) static YOUTUBE_PATTERN: LazyLock<Regex> = LazyLock::new(|| {
...
pub(crate) static INSTAGRAM_PATTERN: LazyLock<Regex> = LazyLock::new(|| {
...
pub(crate) static VK_PATTERN: LazyLock<Regex> = LazyLock::new(|| {
